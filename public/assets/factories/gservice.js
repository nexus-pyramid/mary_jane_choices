...
angular.module('gservice', [])
    .factory('gservice', function($rootScope, $http, LocationService){
        ...
        googleMapService.getDisp = function(latitude, longitude, callback, filteredResults){
            ...
            if (filteredResults){
              ...
              console.log(locations)
                ...
                // Then, initialize the map -- noting that a filter was used (to mark icons yellow)
                initialize1(latitude, longitude, true);
            }
            ...
            // If no filter is provided in the refresh() call...
                ...
                $http.post('/getDispensaries', coords).then(function(response, err){
                  ...
                  console.log(response)
                    ...
                    locations = convertToMapPoints(response);
                    initialize1(latitude, longitude, false);
        ...
        googleMapService.getDocs = function(latitude, longitude, callback, filteredResults){
            ...
            if (filteredResults){
              ...
              console.log(locations)
                ...
                // Then, initialize the map -- noting that a filter was used (to mark icons yellow)
                initialize2(latitude, longitude, true);
            }
            ...
            // If no filter is provided in the refresh() call...
                ...
                $http.post('/getDoctors', coords).then(function(response, err){
                  console.log('getting doctors gservice' + response)
                    ...
                    locations = convertToMapPoints(response);
                    initialize2(latitude, longitude, false);
        ...
        var initialize = function(latitude, longitude, filter) {
            ...
            var icon = {
                url: 'assets/factories/DELIVERIES.png',
        ...
        var initialize1 = function(latitude, longitude, filter) {
            ...
            if(filter){
                ...
                del = "assets/factories/shops.png"
            var icon = {
                url: 'assets/factories/DELIVERIES.png',
                // size:  new google.maps.Size(20, 32),
                scaledSize: new google.maps.Size(54, 60), // scaled size
        ...
        var initialize2 = function(latitude, longitude, filter) {
            ...
            if(filter){
                ...
                del = "assets/factories/doctors.png"
            var icon = {
                url: 'assets/factories/DELIVERIES.png',
                // size:  new google.maps.Size(20, 32),
                scaledSize: new google.maps.Size(54, 60), // scaled size
